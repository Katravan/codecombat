...
#    tip_optimization_operator: "Every language has an optimization operator. In most languages that operator is ‘//’"
    tip_lines_of_code: "Mesurer l'avancement d'un programme avec le nombre de lignes c'est comme mesurer l'avancement de la construction d'un avion avec son poids. — Bill Gates"
    tip_source_code: "Je veux changer le monde mais ils n'ont jamais voulu me donner le code source."
#    tip_javascript_java: "Java is to JavaScript what Car is to Carpet. - Chris Heilmann"
    tip_move_forward: "Quoi que vous fassiez, continuez d'avancer. - Martin Luther King Jr."
    tip_google: "Vous avez un problème que vous ne pouvez pas résoudre? Chercher sur Google !"
